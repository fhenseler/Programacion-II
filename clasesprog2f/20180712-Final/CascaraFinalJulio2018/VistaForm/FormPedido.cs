...
namespace VistaForm
{
    public partial class FormPedido : Form
    {
        ...
        private void btnAgregarA_Click(object sender, EventArgs e)
        {
            ...
            this.lstTerminados.Items.Add(productoA.Mostrar());
            count += 1;
        ...
        {          
            ...
            productoB.InformarProductoTerminado += new ProductoB.ProductoTerminado(TotalizarProductosTerminados);
            productoB.InformarProductoTerminado += new ProductoB.ProductoTerminado(AgregarProductoTerminado);
            
            this.pedido += productoB;
            this.lstTerminados.Items.Add(productoB.Mostrar());
            count += 1;
