...
namespace Entidades
{
    ...
    public class Grupo : IEntradaSalida<Grupo>
    {
        ...
        public static Grupo operator +(Grupo g, Equipo e)
        {
            ...
            {
                throw new GrupoLlenoException("El Grupo {0} ya cuenta con {1} equipos" + g.grupos + g.maxCantidad);
            }
        ...
        public Grupo Leer(Grupo v)
        {         
            GrupoDAO.Leer(v);
            foreach(Equipo e in v.equipos)
            {
                this.equipos.Add(e);
            }
            return this;
